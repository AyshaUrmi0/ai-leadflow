  ...
  return (
    <section id="contact" className="bg-teal-800 py-20 sm:py-24">
      <div className="mx-auto max-w-3xl px-5 text-center sm:px-6 lg:px-8">
        ...
        <a
          href="#contact"
          className="mt-8 inline-flex min-h-12 items-center justify-center rounded-md bg-white px-5 text-sm font-semibold text-teal-900 hover:bg-teal-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
        >
          Book a consultation
        </a>
      </div>
